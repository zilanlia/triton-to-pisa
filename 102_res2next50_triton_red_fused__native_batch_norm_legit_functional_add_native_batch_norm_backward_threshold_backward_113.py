...
def call(args):
    with torch.xpu._DeviceGuard(0):
        ...
        triton_red_fused__native_batch_norm_legit_functional_add_native_batch_norm_backward_threshold_backward_113.run(*args, 256, 401408, grid=grid(256), stream=stream0)
