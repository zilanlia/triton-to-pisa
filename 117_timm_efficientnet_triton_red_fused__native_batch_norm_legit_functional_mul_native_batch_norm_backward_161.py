...
#     filename=__file__,
#     meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: '*fp32', 4: '*fp32', 5: '*fp32', 6: 'i32', 7: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__native_batch_norm_legit_functional_mul_native_batch_norm_backward_161', 'configs': [instance_descriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7), equal_to_1=(), ids_of_folded_args=(), divisible_by_8=(6, 7))]}
# )
@triton.jit
...
def call(args):
    ...
    grid=lambda meta: (43008, )
    triton_red_fused__native_batch_norm_legit_functional_mul_native_batch_norm_backward_161[grid](*args, 43008, 896, 1, 256)
