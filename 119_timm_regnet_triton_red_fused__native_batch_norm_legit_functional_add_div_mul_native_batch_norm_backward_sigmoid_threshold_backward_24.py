...
def call(args):
    ...
    grid=lambda meta: (896, )
    triton_red_fused__native_batch_norm_legit_functional_add_div_mul_native_batch_norm_backward_sigmoid_threshold_backward_24[grid](*args, 896, 6272, 1, 256)
