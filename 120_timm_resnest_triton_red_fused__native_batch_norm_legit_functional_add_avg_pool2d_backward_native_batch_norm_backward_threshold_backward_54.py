...
def call(args):
    ...
    triton_red_fused__native_batch_norm_legit_functional_add_avg_pool2d_backward_native_batch_norm_backward_threshold_backward_54[grid](*args, 256, 100352, 1, 256)
