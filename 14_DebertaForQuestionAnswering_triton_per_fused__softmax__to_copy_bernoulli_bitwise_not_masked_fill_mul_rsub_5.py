...
#     filename=__file__,
#     meta={'signature': {0: '*bf16', 1: '*i64', 2: '*i1', 3: '*bf16', 4: '*bf16', 5: 'i32', 6: 'i32', 7: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__softmax__to_copy_bernoulli_bitwise_not_masked_fill_mul_rsub_5', 'configs': [instance_descriptor(divisible_by_16=(0, 1, 2, 3, 4, 6, 7), equal_to_1=(), ids_of_folded_args=(), divisible_by_8=(6, 7))]}
# )
@triton.jit
...
def call(args):
    ...
    triton_per_fused__softmax__to_copy_bernoulli_bitwise_not_masked_fill_mul_rsub_5[grid](*args, 98304, 512)
