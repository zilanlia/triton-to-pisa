...
def get_args():
    ...
    arg_2 = rand_strided((64, 4, 512, 512), (1048576, 262144, 512, 1), device='xpu:0', dtype=torch.bool)
    arg_3 = rand_strided((64, 4, 512, 512), (1048576, 262144, 512, 1), device='xpu:0', dtype=torch.float32)
    arg_4 = rand_strided((64, 4, 512, 512), (1048576, 262144, 512, 1), device='xpu:0', dtype=torch.bfloat16)
    arg_5 = 0
...
def call(args):
    with torch.xpu._DeviceGuard(0):
        ...
        triton_per_fused__softmax__to_copy_add_div_native_dropout_6.run(*args, 131072, 512, grid=grid(131072), stream=stream0)


def benchmark_all_configs(args):
    with torch.xpu._DeviceGuard(0):
        torch.xpu.set_device(0)
        return triton_per_fused__softmax__to_copy_add_div_native_dropout_6.benchmark_all_configs(*args, 131072, 512, grid=grid(131072))
