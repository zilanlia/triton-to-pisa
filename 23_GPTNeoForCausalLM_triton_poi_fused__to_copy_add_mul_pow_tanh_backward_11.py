...
@pointwise(size_hints=[33554432], filename=__file__, meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*fp32', 3: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__to_copy_add_mul_pow_tanh_backward_11', 'configs': [instance_descriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=(), ids_of_folded_args=(), divisible_by_8=(3,))]})
@triton.jit
...
def get_args():
    ...
    arg_1 = rand_strided((4096, 8192), (8192, 1), device='xpu:0', dtype=torch.bfloat16)
...
def call(args):
    with torch.xpu._DeviceGuard(0):
        ...
        triton_poi_fused__to_copy_add_mul_pow_tanh_backward_11.run(*args, 33554432, grid=grid(33554432), stream=stream0)


def benchmark_all_configs(args):
    with torch.xpu._DeviceGuard(0):
        torch.xpu.set_device(0)
        return triton_poi_fused__to_copy_add_mul_pow_tanh_backward_11.benchmark_all_configs(*args, 33554432, grid=grid(33554432))
