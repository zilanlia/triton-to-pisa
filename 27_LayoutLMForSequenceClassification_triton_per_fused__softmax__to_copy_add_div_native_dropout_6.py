...
def get_args():
    ...
    arg_1 = rand_strided((38,), (1,), device='xpu:0', dtype=torch.int64)
...
def call(args):
    with torch.xpu._DeviceGuard(0):
        ...
        triton_per_fused__softmax__to_copy_add_div_native_dropout_6.run(*args, 98304, 512, grid=grid(98304), stream=stream0)


def benchmark_all_configs(args):
    with torch.xpu._DeviceGuard(0):
        torch.xpu.set_device(0)
        return triton_per_fused__softmax__to_copy_add_div_native_dropout_6.benchmark_all_configs(*args, 98304, 512, grid=grid(98304))
