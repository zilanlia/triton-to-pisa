...
def call(args):
    with torch.xpu._DeviceGuard(0):
        ...
        triton_red_fused__to_copy_add_native_layer_norm_native_layer_norm_backward_sum_14.run(*args, 4096, 2048, grid=grid(4096), stream=stream0)


def benchmark_all_configs(args):
    with torch.xpu._DeviceGuard(0):
        torch.xpu.set_device(0)
        return triton_red_fused__to_copy_add_native_layer_norm_native_layer_norm_backward_sum_14.benchmark_all_configs(*args, 4096, 2048, grid=grid(4096))
