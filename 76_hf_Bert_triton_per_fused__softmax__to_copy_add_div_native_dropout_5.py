...
@persistent_reduction(
    ...
    filename=__file__,
    meta={'signature': {0: '*bf16', 1: '*i64', 2: '*i1', 3: '*fp32', 4: '*bf16', 5: 'i32', 6: 'i32', 7: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__softmax__to_copy_add_div_native_dropout_5', 'configs': [instance_descriptor(divisible_by_16=(0, 1, 2, 3, 4, 6, 7), equal_to_1=(), ids_of_folded_args=(), divisible_by_8=(6, 7))]}
)
@triton.jit
def triton_per_fused__softmax__to_copy_add_div_native_dropout_5(in_ptr0, in_ptr1, out_ptr3, out_ptr4, out_ptr5, load_seed_offset, xnumel, rnumel):
    xnumel = 24576
...
def get_args():
    ...
    arg_2 = rand_strided((4, 12, 512, 512), (3145728, 262144, 512, 1), device='xpu:0', dtype=torch.bool)
    arg_3 = rand_strided((4, 12, 512, 512), (3145728, 262144, 512, 1), device='xpu:0', dtype=torch.float32)
    arg_4 = rand_strided((4, 12, 512, 512), (3145728, 262144, 512, 1), device='xpu:0', dtype=torch.bfloat16)
    arg_5 = 0
...
def call(args):
    with torch.xpu._DeviceGuard(0):
        ...
        triton_per_fused__softmax__to_copy_add_div_native_dropout_5.run(*args, 24576, 512, grid=grid(24576), stream=stream0)


def benchmark_all_configs(args):
    with torch.xpu._DeviceGuard(0):
        torch.xpu.set_device(0)
        return triton_per_fused__softmax__to_copy_add_div_native_dropout_5.benchmark_all_configs(*args, 24576, 512, grid=grid(24576))
