...
def get_args():
    ...
    arg_3 = rand_strided((16, 12, 512, 512), (3145728, 262144, 512, 1), device='xpu:0', dtype=torch.float32)
...
def call(args):
    with torch.xpu._DeviceGuard(0):
        ...
        triton_per_fused__softmax__to_copy_add_div_native_dropout_5.run(*args, 98304, 512, grid=grid(98304), stream=stream0)


def benchmark_all_configs(args):
    with torch.xpu._DeviceGuard(0):
        torch.xpu.set_device(0)
        return triton_per_fused__softmax__to_copy_add_div_native_dropout_5.benchmark_all_configs(*args, 98304, 512, grid=grid(98304))
