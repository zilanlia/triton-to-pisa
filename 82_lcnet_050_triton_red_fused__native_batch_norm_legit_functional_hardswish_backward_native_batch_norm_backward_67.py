...
def call(args):
    with torch.xpu._DeviceGuard(0):
        ...
        triton_red_fused__native_batch_norm_legit_functional_hardswish_backward_native_batch_norm_backward_67.run(*args, 3584, 3584, grid=grid(3584), stream=stream0)
