...
def call(args):
    ...
    grid=lambda meta: (308281344, )
    triton_poi_fused__native_batch_norm_legit_functional_native_batch_norm_backward_threshold_backward_263[grid](*args, 308281344, 1)
