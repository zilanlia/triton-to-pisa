...
#     filename=__file__,
#     meta={'signature': {0: '*bf16', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: 'i32', 5: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__native_batch_norm_legit_functional_6', 'configs': [instance_descriptor(divisible_by_16=(0, 1, 2, 3, 4), equal_to_1=(), ids_of_folded_args=(), divisible_by_8=(4,))]}
# )
@triton.jit
...
def call(args):
    ...
    grid=lambda meta: (240, )
    triton_red_fused__native_batch_norm_legit_functional_6[grid](*args, 240, 160564, 1, 256)
