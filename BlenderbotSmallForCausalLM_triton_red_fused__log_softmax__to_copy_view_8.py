# kernel path: /data/liyang/pytorch/inductor_log/huggingface/BlenderbotSmallForCausalLM/amp_bf16/ad/cad57srykyvfi4xwo7c3wijcpgjseoylt5tyycfyztbdji2wktgk.py
# Source Nodes: [cross_entropy, l__self___lm_head], Original ATen: [aten._log_softmax, aten._to_copy, aten.view]
# cross_entropy => amax_8, convert_element_type_154, exp_8, sub_25, sum_9
# l__self___lm_head => view_179
...
def get_args():
    arg_0 = rand_strided((64, 128, 50265), (6433920, 50265, 1), device='xpu:0', dtype=torch.bfloat16)
