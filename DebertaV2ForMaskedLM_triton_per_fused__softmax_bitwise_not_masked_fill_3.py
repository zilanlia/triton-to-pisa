# kernel path: /data/liyang/pytorch/inductor_log/huggingface/DebertaV2ForMaskedLM/amp_bf16/4s/c4sqiegn3ejgjrre3i6owdw25l4q67o2gwiq4lbw7dnl6fakepat.py
...
def get_args():
    ...
    arg_1 = rand_strided((2, 24, 512, 512), (6291456, 262144, 512, 1), device='xpu:0', dtype=torch.bfloat16)
    return arg_0, arg_1,
...
def call(args):
    with torch.xpu._DeviceGuard(0):
        ...
        triton_per_fused__softmax_bitwise_not_masked_fill_3.run(*args, 24576, 512, grid=grid(24576), stream=stream0)


def benchmark_all_configs(args):
    with torch.xpu._DeviceGuard(0):
        torch.xpu.set_device(0)
        return triton_per_fused__softmax_bitwise_not_masked_fill_3.benchmark_all_configs(*args, 24576, 512, grid=grid(24576))
