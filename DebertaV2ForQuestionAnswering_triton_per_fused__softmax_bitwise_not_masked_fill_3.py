# kernel path: /data/liyang/pytorch/inductor_log/huggingface/DebertaV2ForQuestionAnswering/amp_bf16/ca/ccadwlrbc5l5fnh6s6unxsz5yvumvews2gswebfumzbf7s3zgpar.py
...
# softmax => amax, convert_element_type_12, convert_element_type_13, div_1, exp, sub_1, sum_1
...
def get_args():
    arg_0 = rand_strided((24, 512, 512), (262144, 512, 1), device='xpu:0', dtype=torch.bfloat16)
    arg_1 = rand_strided((1, 24, 512, 512), (6291456, 262144, 512, 1), device='xpu:0', dtype=torch.bfloat16)
    return arg_0, arg_1,
...
def call(args):
    with torch.xpu._DeviceGuard(0):
        ...
        triton_per_fused__softmax_bitwise_not_masked_fill_3.run(*args, 12288, 512, grid=grid(12288), stream=stream0)


def benchmark_all_configs(args):
    with torch.xpu._DeviceGuard(0):
        torch.xpu.set_device(0)
        return triton_per_fused__softmax_bitwise_not_masked_fill_3.benchmark_all_configs(*args, 12288, 512, grid=grid(12288))
