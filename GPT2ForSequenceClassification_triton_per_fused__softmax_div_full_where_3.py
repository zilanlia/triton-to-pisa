# kernel path: /data/liyang/pytorch/inductor_log/huggingface/GPT2ForSequenceClassification/amp_bf16/5o/c5oirh4l3yyg32mfgui6sbrjyi4lwyo3mvz7gs6ueoqi4sqdrs6f.py
...
def get_args():
    ...
    arg_2 = rand_strided((4, 12, 1024, 1024), (12582912, 1048576, 1024, 1), device='xpu:0', dtype=torch.bfloat16)
...
def call(args):
    with torch.xpu._DeviceGuard(0):
        ...
        triton_per_fused__softmax_div_full_where_3.run(*args, 49152, 1024, grid=grid(49152), stream=stream0)


def benchmark_all_configs(args):
    with torch.xpu._DeviceGuard(0):
        torch.xpu.set_device(0)
        return triton_per_fused__softmax_div_full_where_3.benchmark_all_configs(*args, 49152, 1024, grid=grid(49152))
