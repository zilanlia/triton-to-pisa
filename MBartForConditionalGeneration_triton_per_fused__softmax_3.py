# kernel path: /data/liyang/pytorch/inductor_log/huggingface/MBartForConditionalGeneration/amp_bf16/ge/cgetzdass6kdu4derbmyqau6q25ng2r7c5x63bbidwpc4t35usll.py
# Source Nodes: [softmax], Original ATen: [aten._softmax]
# softmax => amax, convert_element_type_10, convert_element_type_9, div, exp, sub_3, sum_2
...
def call(args):
    with torch.xpu._DeviceGuard(0):
        ...
        triton_per_fused__softmax_3.run(*args, 32768, 1024, grid=grid(32768), stream=stream0)


def benchmark_all_configs(args):
    with torch.xpu._DeviceGuard(0):
        torch.xpu.set_device(0)
        return triton_per_fused__softmax_3.benchmark_all_configs(*args, 32768, 1024, grid=grid(32768))
