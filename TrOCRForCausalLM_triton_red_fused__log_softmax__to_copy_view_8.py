# kernel path: /data/liyang/pytorch/inductor_log/huggingface/TrOCRForCausalLM/amp_bf16/gv/cgvmtgcpzwlrtip6ufclej2paqwagffpsli3d6mhi3utu5z6rlwu.py
# Source Nodes: [cross_entropy, l__self___output_projection], Original ATen: [aten._log_softmax, aten._to_copy, aten.view]
# cross_entropy => amax_12, convert_element_type_230, exp_12, sub_37, sum_13
# l__self___output_projection => view_267
...
def get_args():
    arg_0 = rand_strided((32, 256, 50265), (12867840, 50265, 1), device='xpu:0', dtype=torch.bfloat16)
...
def call(args):
    with torch.xpu._DeviceGuard(0):
        ...
        triton_red_fused__log_softmax__to_copy_view_8.run(*args, 8192, 50265, grid=grid(8192), stream=stream0)


def benchmark_all_configs(args):
    with torch.xpu._DeviceGuard(0):
        torch.xpu.set_device(0)
        return triton_red_fused__log_softmax__to_copy_view_8.benchmark_all_configs(*args, 8192, 50265, grid=grid(8192))
