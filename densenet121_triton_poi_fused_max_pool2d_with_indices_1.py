# kernel path: /data/liyang/pytorch/inductor_log/torchbench/densenet121/amp_bf16/k7/ck73sf63skrsmdgk5sefvv4uvxmfwcoztzfc4bswizcitlof5hrv.py
# Source Nodes: [l__self___features_pool0], Original ATen: [aten.max_pool2d_with_indices]
# l__self___features_pool0 => max_pool2d_with_indices
...
def triton_poi_fused_max_pool2d_with_indices_1(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tl.store(out_ptr0 + (x0 + (96*x6)), tmp60, None)


def get_args():
    arg_0 = rand_strided((64, 64, 112, 112), (802816, 1, 7168, 64), device='xpu:0', dtype=torch.bfloat16)
    arg_1 = rand_strided((64, 64, 56, 56), (301056, 1, 5376, 96), device='xpu:0', dtype=torch.bfloat16)
    return arg_0, arg_1,
