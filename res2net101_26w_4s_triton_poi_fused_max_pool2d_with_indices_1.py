# kernel path: /data/liyang/pytorch/inductor_log/timm_models/res2net101_26w_4s/amp_bf16/fg/cfgoo3hjeuofl7x23lqzskxaqf3kzmsjbhkxxe6u2xjwjmyy4pdx.py
...
def get_args():
    ...
    arg_1 = rand_strided((64, 64, 56, 56), (200704, 1, 3584, 64), device='xpu:0', dtype=torch.bfloat16)
    return arg_0, arg_1,
