# kernel path: /data/liyang/pytorch/inductor_log/timm_models/res2net50_14w_8s/amp_bf16/rj/crjpzzcw35ygnldttkkzkgf37dmdsae3hbnkmhkp5q7j3jcaax5y.py
...
def get_args():
    ...
    arg_1 = rand_strided((128, 64, 56, 56), (200704, 1, 3584, 64), device='xpu:0', dtype=torch.bfloat16)
    return arg_0, arg_1,
...
def call(args):
    with torch.xpu._DeviceGuard(0):
        ...
        triton_poi_fused_max_pool2d_with_indices_1.run(*args, 25690112, grid=grid(25690112), stream=stream0)


def benchmark_all_configs(args):
    with torch.xpu._DeviceGuard(0):
        torch.xpu.set_device(0)
        return triton_poi_fused_max_pool2d_with_indices_1.benchmark_all_configs(*args, 25690112, grid=grid(25690112))
