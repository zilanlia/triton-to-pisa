# kernel path: /data/liyang/pytorch/inductor_log/torchbench/resnext50_32x4d/amp_bf16/gg/cggenxlrbu43ihnxyvewrueduikedgtwwutqwc4xzjh2j7ghub74.py
...
@pointwise(size_hints=[2097152], filename=__file__, meta={'signature': {0: '*bf16', 1: '*bf16', 2: 'i32'}, 'device': 0, 'device_type': 'xpu', 'constants': {}, 'mutated_arg_names': [], 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_max_pool2d_with_indices_1', 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]})
@triton.jit
...
def get_args():
    arg_0 = rand_strided((8, 64, 112, 112), (802816, 1, 7168, 64), device='xpu:0', dtype=torch.bfloat16)
    arg_1 = rand_strided((8, 64, 56, 56), (200704, 1, 3584, 64), device='xpu:0', dtype=torch.bfloat16)
    return arg_0, arg_1,
...
def call(args):
    with torch.xpu._DeviceGuard(0):
        ...
        triton_poi_fused_max_pool2d_with_indices_1.run(*args, 1605632, grid=grid(1605632), stream=stream0)


def benchmark_all_configs(args):
    with torch.xpu._DeviceGuard(0):
        torch.xpu.set_device(0)
        return triton_poi_fused_max_pool2d_with_indices_1.benchmark_all_configs(*args, 1605632, grid=grid(1605632))
