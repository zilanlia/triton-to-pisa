# kernel path: /data/liyang/pytorch/inductor_log/timm_models/swsl_resnext101_32x16d/amp_bf16/q3/cq3lp2utaqxeqzfromviiazx2mhvgkp2umyivudsr2j7q7qlcx6a.py
...
def get_args():
    arg_0 = rand_strided((32, 64, 112, 112), (802816, 1, 7168, 64), device='xpu:0', dtype=torch.bfloat16)
    arg_1 = rand_strided((32, 64, 56, 56), (200704, 1, 3584, 64), device='xpu:0', dtype=torch.bfloat16)
    return arg_0, arg_1,
...
def call(args):
    with torch.xpu._DeviceGuard(0):
        ...
        triton_poi_fused_max_pool2d_with_indices_1.run(*args, 6422528, grid=grid(6422528), stream=stream0)


def benchmark_all_configs(args):
    with torch.xpu._DeviceGuard(0):
        torch.xpu.set_device(0)
        return triton_poi_fused_max_pool2d_with_indices_1.benchmark_all_configs(*args, 6422528, grid=grid(6422528))
