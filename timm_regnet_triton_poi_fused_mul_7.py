# kernel path: /data/liyang/pytorch/inductor_log/torchbench/timm_regnet/amp_bf16/f7/cf7unuw2j47o2qhjsnmflrfnp5ntkmqyw5dfd666ay7t5m6hkukl.py
...
def get_args():
    arg_0 = rand_strided((32, 896, 14, 14), (175616, 1, 12544, 896), device='xpu:0', dtype=torch.bfloat16)
    arg_1 = rand_strided((32, 896, 1, 1), (896, 1, 896, 896), device='xpu:0', dtype=torch.bfloat16)
    return arg_0, arg_1,
...
def call(args):
    with torch.xpu._DeviceGuard(0):
        ...
        triton_poi_fused_mul_7.run(*args, 5619712, grid=grid(5619712), stream=stream0)


def benchmark_all_configs(args):
    with torch.xpu._DeviceGuard(0):
        torch.xpu.set_device(0)
        return triton_poi_fused_mul_7.benchmark_all_configs(*args, 5619712, grid=grid(5619712))
