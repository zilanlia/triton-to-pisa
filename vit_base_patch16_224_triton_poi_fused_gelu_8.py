# kernel path: /data/liyang/pytorch/inductor_log/timm_models/vit_base_patch16_224/amp_bf16/vo/cvolwivkdib2xyd3agiv5b7ic6csz4imm3y2jjdtgtsoomqsumiu.py
...
def get_args():
    arg_0 = rand_strided((64, 197, 3072), (605184, 3072, 1), device='xpu:0', dtype=torch.bfloat16)
    return arg_0,
...
def call(args):
    with torch.xpu._DeviceGuard(0):
        ...
        triton_poi_fused_gelu_8.run(*args, 38731776, grid=grid(38731776), stream=stream0)


def benchmark_all_configs(args):
    with torch.xpu._DeviceGuard(0):
        torch.xpu.set_device(0)
        return triton_poi_fused_gelu_8.benchmark_all_configs(*args, 38731776, grid=grid(38731776))
